    ...
    <section id="sobre-mi" className="sobre-mi seccion-oscura">
      <div className="contenedor">
        ...
        <p className="seccion-texto">
          ...
          guiaron a dar mis primeros pasos. Ansioso por ya tener la primera
          experiencia laboral y reforzar los conocimientos aprendidos y con
          mucho animo de seguir creciendo y aprendiendo dia a dia.
        </p>
      </div>
    </section>
  );
